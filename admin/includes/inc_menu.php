...
$modules['03_promotion']['11_favourable']           = 'favourable.php?act=list';
$modules['03_promotion']['12_favourable']           = 'favourable2.php?act=list';
...
$modules['03_promotion']['16_vip_goods']       = 'vip_goods.php?act=list';
...
$modules['11_system']['wj_award_type']              = 'wj_award_type.php?act=edit';    //赠送积分设置
	...
	/*新加的*/
$modules['04_order']['01_handle_complain']          = 'order.php?act=user_complain';
...
$modules['04_order']['11_order_list']          = 'order.php?act=kuai_list';
...
$modules['08_members']['msg']                       = 'msg.php?act=list_all';// 0901-guan
...
$modules['17_second_feature']['17_coupons']        = 'coupons.php?act=list';
$modules['17_second_feature']['17_order_discount']        = 'order_discount.php';
?>
