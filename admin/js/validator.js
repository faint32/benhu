...
var Validator = function(name)
{
  ...
  * @param :  required    是否必须
  */
this.isNumberArray = function(controlId, msg,required)
{

    //var arr = $('input[name="'+controlId+'"]');

               var arr = document.getElementsByName(controlId);
...
/*
   $('input[name="'+controlId+'"]').each(function(index){
    var value = $(this).val();
