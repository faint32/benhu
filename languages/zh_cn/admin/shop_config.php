...
$_LANG['cfg_name']['register_points'] = '完善资料达80%赠送积分';
$_LANG['cfg_name']['daily_attent'] = '每日签到赠送积分';  //edit by chen-0910
$_LANG['cfg_name']['comment_integral'] = '评论获取积分';  //edit by chen-1009
$_LANG['cfg_name']['comment_shaidan'] = '晒单评论额外获取积分';
$_LANG['cfg_name']['validated_integral'] = '邮箱或手机验证获得积分';
$_LANG['cfg_name']['package_buy'] = '搭配套餐折扣率';
$_LANG['cfg_name']['top5_integral'] = '前5条评论获取积分';
...
$_LANG['cfg_desc']['package_buy'] = '折扣率为0-1之间的小数。0.00-表示免费，1.00-表示没打折，0.50-表示5折';
