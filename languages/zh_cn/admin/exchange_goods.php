...
$_LANG['needed_money'] = '还需现金';
$_LANG['is_exchange'] ='是否可兑换';
$_LANG['is_hot'] ='是否热销';
$_LANG['is_best'] ='是否超值兑换'; // chen 0901
$_LANG['is_new'] ='是否精品上新';  // chen 0901
...
$_LANG['isbest'] ='超值兑换'; // chen 0901
$_LANG['isnew'] ='精品上新';  // chen 0901
$_LANG['isnotbest'] ='非超值兑换';
$_LANG['isnotnew'] ='非精品上新';

$_LANG['notice_goodsid'] ='需要先搜索商品，生成商品列表，然后再选择';
$_LANG['notice_integral'] ='兑换本商品需要消耗的积分值';
$_LANG['notice_needed_money'] ='兑换本商品还需要的钱'; // chen 0901
