...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $parameter = array(
            ...
            'logistics_fee'     => $order['shipping_fee'],//运费
      ...
      $button = '<div style="position: absolute; opacity: 0; filter:Alpha(opacity=0);"><input id="pay_btn" type="button" onclick="window.open(\'https://mapi.alipay.com/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="' .$GLOBALS['_LANG']['pay_button']. '" /></div>';
