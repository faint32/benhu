...
<form method="post" action="favourable2.php" name="listForm" onsubmit="return confirm(batch_drop_confirm);">
...
?>
    <tr>
      ...
      <td align="center">
        <a href="favourable2.php?act=edit&amp;id=<?php echo $this->_var['favourable']['act_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
