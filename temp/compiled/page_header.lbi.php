...
<?php echo $this->smarty_insert_scripts(array('files'=>'jquery-1.9.1.min.js,jquery.SuperSlide.js,transport.js')); ?>
<script type="text/javascript" src="style/js/combine/page_header.js"></script>
